...
public class FileSystemStorageService implements StorageService {
    ...
    @Autowired
    public FileSystemStorageService(@Qualifier(value = "PersonalStorageService") StorageProperties properties, FileService fileService) {
    ...
    public void store(MultipartFile file) {
        String filename = randomNum() + StringUtils.cleanPath(file.getOriginalFilename());
        try {
            if (file.isEmpty()) {
